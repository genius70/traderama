...
const HeroSection = () => {
  ...
  return <div className="bg-gradient-to-br from-blue-50 to-indigo-100 py-20">
      {/* Hero Section */}
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          <div className="text-center space-y-8">
            ...
            <p className="text-lg sm:text-xl text-gray-300 max-w-2xl mx-auto">
              Copy successful traders, automate your strategies, and connect
              to top brokers. Join thousands of traders maximizing their
